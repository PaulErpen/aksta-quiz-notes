...
## Base R: How do you plot the pair-wise scatterplots of a matrix?
...
## Base R: What are 3 methods fro displaying 3-dimensional data
...
## Base R: What are useful functions and parameters used for styling plots?
...
## Base R: Qhat are two different types of interactive functions in R?
